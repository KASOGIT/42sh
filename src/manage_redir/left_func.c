/*
** left_func.c for  in /home/soto_a/rendu/PSU_2014_42sh/refurbish_42sh/src/manage_redir
** 
** Made by adam soto
** Login   <soto_a@epitech.net>
** 
** Started on  Fri May  8 14:52:54 2015 adam soto
** Last update Sun May 24 02:43:25 2015 adam soto
*/

#include "42sh.h"

static int	exec_left(t_tree **node, int fd_file)
{
  dup2(fd_file, 0);
  run_tree(&((*node)->left));
  return (EXIT_FAILURE);
...
int		left_func(t_tree **node)
{
  ...
  if ((*node)->right && (*node)->left
      ...
      && (tab_epur_name = str_to_wordtab((*node)->right->data)) != NULL)
    {
      ...
      if ((fd_file = open(tab_epur_name[0], O_RDONLY, g_info.mode)) == -1)
